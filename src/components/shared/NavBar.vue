    ...
    <div class="container">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav class="m-auto">
          <b-nav-item :class="{'is-active': $route.path === '/'}"  to="/" class="px-3">Home</b-nav-item>
          <b-nav-item-dropdown :class="{'is-active': $route.path !== '/'}" class="px-3" no-caret @toggle="getDegree">
            <template #button-content >
              Docs
               <transition name="flip" mode="out-in">
                 <b-icon class="dropdown-icon" icon="chevron-down" font-scale="0.9" aria-hidden="true" :rotate="degree"  :key="degree"></b-icon>
               </transition>
            </template>
                <b-dropdown-item to="/docs">Documentation</b-dropdown-item>
